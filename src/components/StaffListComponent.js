        ...
        return(
            < div className='container'>
                <div className='row BTN'>
                    ...
                    <button className='btn btn-success m-3' onClick={()=>this.columSelect("col-12 col-md-3 mt-3")}>3 cột</button>
                    <button className='btn btn-success m-3' onClick={()=>this.columSelect("col-12 col-md-2 mt-3")}>2 cột</button>
